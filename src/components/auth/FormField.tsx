  ...
  return (
    <div>
      ...
      <div className="relative">
        <span className="absolute top-1/2 left-3 size-4 -translate-y-1/2 text-muted-foreground/60">{icon}</span>
        <input
          id={id}
          name={name ?? id}
          type={type}
          ...
          className={cn(
            inputBase,
            error ? "border-red-400/60 focus:ring-red-400" : "border-border focus:ring-purple-400",
          )}
        />
        {endContent}
      </div>
